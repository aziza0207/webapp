# Generated by Django 4.2.4 on 2023-09-01 07:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_ky', models.TextField(max_length=500, null=True, verbose_name='description')),
                ('is_active', models.BooleanField(default=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_ky', models.CharField(max_length=50, null=True, verbose_name='title')),
                ('description', models.TextField(max_length=100, verbose_name='description')),
                ('description_en', models.TextField(max_length=100, null=True, verbose_name='description')),
                ('description_ru', models.TextField(max_length=100, null=True, verbose_name='description')),
                ('description_ky', models.TextField(max_length=100, null=True, verbose_name='description')),
                ('image', models.ImageField(blank=True, null=True, upload_to='images/', verbose_name='image')),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('is_active', models.BooleanField(default=True)),
            ],
